		...
		<div class="row clearfix">
			<div class="col-md-2 column">
				...
				<ul class="nav nav-stacked nav-pills" id="leftMenu">
					...
					<li class="active"><a
						href="<%=path%>/adminMangeCheckMessage">报修信息</a><br></li>
			...
			<div class="col-md-10 column">
				<nav class="navbar navbar-default navbar-fixed-top navbar-inverse"
					...
					<div class="collapse navbar-collapse"
						...
						<form class="navbar-form navbar-left" role="search"
							action="<%=path%>/adminSearchCheckMessage" method="post">
						<div class="form-group">
							...
							<div class="form-group">
								<input name="parm" type="text" class="form-control" />
							</div>
				...
				<ul class="nav nav-tabs">
					<li class="active"><a
						href="<%=path%>/adminMangeCheckMessage">等待审查</a></li>
					<li><a href="<%=path%>/adminMangeRepairMessage">等待维修</a></li>
				</ul>
				<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						<%
							...
							List<Seat> checkMessage = (List<Seat>) session.getAttribute("checkMessage");
							if (checkMessage != null && checkMessage.size() != 0) {
								for (Seat seat : checkMessage) {
									if (i == color.size()) {
										i = 0;
									}
						%>
						<tr class="<%=color.get(i)%>">
							...
							<td>
								<!-- <a href="#modal-container-252737" role="button" class="btn" data-toggle="modal"> -->
								<a role="button" class="btn"
								href="<%=path%>/adminAddRepairMessage?seat_id=<%=seat.getSeat_id()%>">
									<em class="glyphicon glyphicon-ok-circle"></em>&nbsp;确认损坏
							</a>
							</td>
							<td>
								<!--	<a href="#modal-container-252736" role="button" class="btn" data-toggle="modal"> -->
								<a role="button" class="btn"
								href="<%=path%>/adminDeleteCheckMessage?seat_id=<%=seat.getSeat_id()%>">
			...
			<a href="<%=path%>/adminMangeAddCheckMessage">
				<button type="button" class="btn btn-default btn-block">添加损坏座位</button>
			</a>
		</div>
		<div class="row clearfix">
			<hr
